...
const Home: React.FC = () => {
  ...
  return (
    <main className="flex flex-col-reverse lg:flex-row max-h-screen min-h-screen">
      ...
      <div className="fixed top-0 left-0 w-screen h-screen lg:hidden z-10 opacity-30">
        <img
          src="/story-illustration.svg"
      ...
      <div className="flex flex-col gap-10 mx-auto flex-1 p-8 justify-center items-center z-20">
        ...
        <button
          onClick={() => signIn()}
          className="mt-auto mb-4 lg:mb-0 lg:mt-0 block p-4 w-full  lg:w-3/4 text-xl text-white font-bold text-center rounded bg-mypink hover:bg-mypink/80"
        >
